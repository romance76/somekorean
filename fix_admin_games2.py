...
function typeLabel(type) {
  return { educational: '📚 교육형', single: '🎯 단일형', betting: '🎰 베팅형', multi: '👥 멀티' }[type] || type
}
...
# Build
print("\n=== npm 빌드 ===")
print(ssh("cd /var/www/somekorean && npm run build 2>&1 | tail -5", timeout=300))
print(ssh("cd /var/www/somekorean && php artisan cache:clear 2>&1"))
print("\n✅ AdminGames.vue 개선 완료!")
c.close()
