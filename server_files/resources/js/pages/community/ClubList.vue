  ...
  <div class="min-h-screen bg-gray-50 pb-16">
    <div class="max-w-[1200px] mx-auto px-4 pt-4">
      <div class="bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-2xl">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-6 py-4 sm:py-5 gap-3">
          <div>
            <h1 class="text-lg sm:text-xl font-black">👥 커뮤니티 동호회</h1>
            <p class="text-blue-100 text-xs sm:text-sm mt-0.5">관심사가 같은 한인들과 함께하세요</p>
          </div>
          <button @click="showCreateModal = true" class="self-start sm:self-auto bg-white text-blue-600 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-bold hover:bg-blue-50 flex-shrink-0">
            + 동호회 만들기
          </button>
        </div>
      </div>
    ...
    <div class="max-w-[1200px] mx-auto px-4 mt-2">
      <div class="bg-white rounded-2xl shadow-sm p-3">
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
          ...
          <button class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-blue-700 w-full sm:w-auto">검색</button>
        </div>
      </div>
    </div>
    <!-- Content area -->
