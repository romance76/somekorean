...
print('\n=== Omok fix + QnA + Clubs deploy ===')

files = [
    ('resources/js/pages/games/OmokGame.vue',         f'{APP}/resources/js/pages/games/OmokGame.vue'),
    ('resources/js/pages/community/QnAHome.vue',      f'{APP}/resources/js/pages/community/QnAHome.vue'),
    ('resources/js/pages/community/ClubList.vue',     f'{APP}/resources/js/pages/community/ClubList.vue'),
