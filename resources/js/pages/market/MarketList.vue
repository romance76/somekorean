  ...
  <div class="max-w-7xl mx-auto px-4 py-5">
    ...
    <div class="mb-4">
      ...
      <div class="flex gap-1.5">
        ...
        <RouterLink v-if="auth.isLoggedIn" to="/market/write" class="bg-amber-400 text-amber-900 font-bold px-4 py-2 rounded-lg text-sm hover:bg-amber-500 flex-shrink-0">✏️<span class="hidden sm:inline"> 등록</span></RouterLink>
      </div>
    </div>
