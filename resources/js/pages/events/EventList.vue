  ...
  <div class="max-w-7xl mx-auto px-4 py-5">
    ...
    <div class="mb-4">
      <div class="flex items-center justify-between mb-2 gap-2">
        <h1 class="text-lg font-black text-gray-800 flex-shrink-0 whitespace-nowrap">🎉 이벤트</h1>
      ...
      <div class="flex gap-1.5">
        ...
        <RouterLink v-if="auth.isLoggedIn" to="/events/create" class="bg-amber-400 text-amber-900 font-bold px-3 py-1.5 rounded-lg text-xs hover:bg-amber-500 flex-shrink-0">✏️<span class="hidden sm:inline"> 등록</span></RouterLink>
      </div>
    </div>
