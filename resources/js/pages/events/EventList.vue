  ...
  <div class="max-w-7xl mx-auto px-4 py-5">
    ...
    <div class="col-span-12 lg:col-span-2 hidden lg:block">
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-20">
        ...
        <button v-for="c in eventCategories" :key="c.value" @click="activeCat=c.value; loadPage()"
    ...
    <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
      ...
      <RouterLink v-if="auth.isLoggedIn" to="/events/create" class="bg-amber-400 text-amber-900 font-bold px-4 py-2 rounded-lg text-sm hover:bg-amber-500 flex-shrink-0">✏️ 등록</RouterLink>
      </div>
