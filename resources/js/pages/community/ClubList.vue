  ...
  <div class="max-w-7xl mx-auto px-4 py-5">
    ...
    <div class="mb-4">
      ...
      <div class="flex gap-1.5">
        <select v-if="type !== 'online' && selectedCityIdx !== '-1' && selectedCityIdx !== -1" v-model="radius" @change="loadClubs()" class="border border-gray-200 rounded-lg px-1.5 py-1 text-[10px] text-gray-600 outline-none flex-shrink-0 w-14">
