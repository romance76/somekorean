<template>
<div>
  <AdminListView icon="🎉" title="이벤트 관리" api-url="/api/events"
    :extra-cols='[{"key":"category","label":"카테고리"},{"key":"city","label":"도시"},{"key":"attendee_count","label":"참가자"},{"key":"start_date","label":"시작일"}]'
