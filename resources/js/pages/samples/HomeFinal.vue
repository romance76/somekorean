...
<div class="min-h-screen bg-gray-100">
  ...
  <div class="bg-emerald-600 text-white text-xs font-bold px-4 py-2 flex items-center justify-between">
    <span>🎯 최종 샘플 — NavBar 유지 + 히어로 + 3-column 포털 + 좌/우 광고</span>
    <div class="flex gap-2">
      <RouterLink to="/home-sample/portal" class="underline">포털</RouterLink>
      <RouterLink to="/home-sample/magazine" class="underline">매거진</RouterLink>
      <RouterLink to="/home-sample/feed" class="underline">피드</RouterLink>
      <RouterLink to="/home-sample/unified" class="underline">통합</RouterLink>
      <RouterLink to="/" class="bg-emerald-900 px-2 py-0.5 rounded">원본 홈</RouterLink>
    </div>
  </div>

  <!-- ═════ 1. 히어로 슬라이드 (기존 스타일 유지) ═════ -->
