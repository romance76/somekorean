...
Route::middleware('auth:api')->group(function () {
    ...
    // Elder Health Records & Medications
    Route::post('elder/health-record',          [ElderController::class, 'storeHealthRecord']);
    Route::get('elder/health-records',           [ElderController::class, 'healthRecords']);
    Route::post('elder/medications',             [ElderController::class, 'setMedication']);
    Route::get('elder/medications',              [ElderController::class, 'getMedications']);
    Route::post('elder/medications/{id}/taken',  [ElderController::class, 'medicationTaken']);
    Route::delete('elder/medications/{id}',      [ElderController::class, 'deleteMedication']);
