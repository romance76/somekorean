...
class RecipePost extends Model {
    ...
    protected $fillable = ['category_id', 'user_id', 'title', 'intro', 'difficulty', 'cook_time', 'calories', 'servings', 'ingredients', 'steps', 'tips', 'tags', 'image_url', 'image_credit', 'view_count', 'like_count', 'bookmark_count', 'source', 'source_url', 'is_hidden'];
